...
namespace USDA.ARS.GRIN.Admin.Repository
{
    ...
    public partial class s9_site_inventory
    {
        public int s9_site_inventory_id { get; set; }
        public int inventory_id { get; set; }
        public string increase_location_code { get; set; }
        ...
        public string virus_status_code { get; set; }
