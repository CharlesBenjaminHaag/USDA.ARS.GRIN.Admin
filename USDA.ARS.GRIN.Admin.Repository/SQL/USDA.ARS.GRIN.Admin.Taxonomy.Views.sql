USE [gringlobal]
GO
/****** Object:  View [dbo].[vw_taxonomy_trait_classes]    Script Date: 4/26/2021 3:12:25 PM ******/
DROP VIEW IF EXISTS [dbo].[vw_taxonomy_trait_classes]
GO
/****** Object:  View [dbo].[vw_taxonomy_genus_lookup]    Script Date: 4/26/2021 3:12:25 PM ******/
DROP VIEW IF EXISTS [dbo].[vw_taxonomy_genus_lookup]
GO
/****** Object:  View [dbo].[vw_taxonomy_genepools]    Script Date: 4/26/2021 3:12:25 PM ******/
DROP VIEW IF EXISTS [dbo].[vw_taxonomy_genepools]
GO
/****** Object:  View [dbo].[vw_taxonomy_genepool_codes]    Script Date: 4/26/2021 3:12:25 PM ******/
DROP VIEW IF EXISTS [dbo].[vw_taxonomy_genepool_codes]
GO
/****** Object:  View [dbo].[vw_taxonomy_cwr_trait_class_lookup]    Script Date: 4/26/2021 3:12:25 PM ******/
DROP VIEW IF EXISTS [dbo].[vw_taxonomy_cwr_trait_class_lookup]
GO
/****** Object:  View [dbo].[vw_taxonomy_cwr_genepool_lookup]    Script Date: 4/26/2021 3:12:25 PM ******/
DROP VIEW IF EXISTS [dbo].[vw_taxonomy_cwr_genepool_lookup]
GO
/****** Object:  View [dbo].[vw_taxonomy_cwr_breeding_type_lookup]    Script Date: 4/26/2021 3:12:25 PM ******/
DROP VIEW IF EXISTS [dbo].[vw_taxonomy_cwr_breeding_type_lookup]
GO
/****** Object:  View [dbo].[vw_taxonomy_breeding_types]    Script Date: 4/26/2021 3:12:25 PM ******/
...
GO
/****** Object:  View [dbo].[vw_taxonomy_cwr_breeding_type_lookup]    Script Date: 4/26/2021 3:12:26 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[vw_taxonomy_cwr_genepool_lookup]    Script Date: 4/26/2021 3:12:26 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[vw_taxonomy_cwr_trait_class_lookup]    Script Date: 4/26/2021 3:12:26 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SELECT  
	...
	AND
		cvl.sys_lang_id = 1
GO
/****** Object:  View [dbo].[vw_taxonomy_genepool_codes]    Script Date: 4/26/2021 3:12:26 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[vw_taxonomy_genepools]    Script Date: 4/26/2021 3:12:26 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[vw_taxonomy_genus_lookup]    Script Date: 4/26/2021 3:12:26 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
--WHERE
 ...
 --)
GO
/****** Object:  View [dbo].[vw_taxonomy_trait_classes]    Script Date: 4/26/2021 3:12:26 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
