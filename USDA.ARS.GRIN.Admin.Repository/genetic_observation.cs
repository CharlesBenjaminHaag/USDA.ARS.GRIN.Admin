...
namespace USDA.ARS.GRIN.Admin.Repository
{
    ...
    public partial class genetic_observation
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public genetic_observation()
        {
            this.genetic_observation_data = new HashSet<genetic_observation_data>();
        }
    
        public int genetic_observation_id { get; set; }
        public int inventory_id { get; set; }
        public Nullable<int> genetic_annotation_id { get; set; }
