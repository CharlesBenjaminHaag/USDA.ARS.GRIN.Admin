CREATE TABLE [nc7_site_inventory] (
    ...
    CONSTRAINT [fk_nc7si_created] FOREIGN KEY ([created_by]) REFERENCES [cooperator] ([cooperator_id]),
    CONSTRAINT [fk_nc7si_i] FOREIGN KEY ([inventory_id]) REFERENCES [inventory] ([inventory_id]),
    CONSTRAINT [fk_nc7si_modified] FOREIGN KEY ([modified_by]) REFERENCES [cooperator] ([cooperator_id]),
    CONSTRAINT [fk_nc7si_owned] FOREIGN KEY ([owned_by]) REFERENCES [cooperator] ([cooperator_id])
);


GO
CREATE NONCLUSTERED INDEX [ndx_fk_nc7si_created]
    ON [nc7_site_inventory]([created_by] ASC);


GO
CREATE UNIQUE NONCLUSTERED INDEX [ndx_fk_nc7si_i]
    ON [nc7_site_inventory]([inventory_id] ASC);


GO
CREATE NONCLUSTERED INDEX [ndx_fk_nc7si_modified]
    ON [nc7_site_inventory]([modified_by] ASC);


GO
CREATE NONCLUSTERED INDEX [ndx_fk_nc7si_owned]
    ON [nc7_site_inventory]([owned_by] ASC);


GO
GRANT DELETE
    ON OBJECT::[nc7_site_inventory] TO [gg_user]
    AS [dbo];
...
GO
GRANT SELECT
    ON OBJECT::[nc7_site_inventory] TO [gg_search]
    AS [dbo];
