CREATE TABLE [dbo].[inventory_quality_status] (
    ...
    CONSTRAINT [fk_iqs_created] FOREIGN KEY ([created_by]) REFERENCES [dbo].[cooperator] ([cooperator_id]),
    CONSTRAINT [fk_iqs_cur] FOREIGN KEY ([tester_cooperator_id]) REFERENCES [dbo].[cooperator] ([cooperator_id]),
    CONSTRAINT [fk_iqs_i] FOREIGN KEY ([inventory_id]) REFERENCES [dbo].[inventory] ([inventory_id]),
    CONSTRAINT [fk_iqs_me] FOREIGN KEY ([method_id]) REFERENCES [dbo].[method] ([method_id]),
    CONSTRAINT [fk_iqs_modified] FOREIGN KEY ([modified_by]) REFERENCES [dbo].[cooperator] ([cooperator_id]),
    CONSTRAINT [fk_iqs_owned] FOREIGN KEY ([owned_by]) REFERENCES [dbo].[cooperator] ([cooperator_id])
);


GO
CREATE NONCLUSTERED INDEX [ndx_fk_iqs_created]
    ON [dbo].[inventory_quality_status]([created_by] ASC);


GO
CREATE NONCLUSTERED INDEX [ndx_fk_iqs_cur]
    ON [dbo].[inventory_quality_status]([tester_cooperator_id] ASC);


GO
CREATE NONCLUSTERED INDEX [ndx_fk_iqs_i]
    ON [dbo].[inventory_quality_status]([inventory_id] ASC);


GO
CREATE NONCLUSTERED INDEX [ndx_fk_iqs_me]
    ON [dbo].[inventory_quality_status]([method_id] ASC);


GO
CREATE NONCLUSTERED INDEX [ndx_fk_iqs_modified]
    ON [dbo].[inventory_quality_status]([modified_by] ASC);


GO
CREATE NONCLUSTERED INDEX [ndx_fk_iqs_owned]
    ON [dbo].[inventory_quality_status]([owned_by] ASC);


GO
CREATE NONCLUSTERED INDEX [ndx_iqs_test]
    ON [dbo].[inventory_quality_status]([test_type_code] ASC, [contaminant_code] ASC);


GO
CREATE UNIQUE NONCLUSTERED INDEX [ndx_uniq_iqs]
    ON [dbo].[inventory_quality_status]([inventory_id] ASC, [test_type_code] ASC, [contaminant_code] ASC, [started_date] ASC, [plant_part_tested_code] ASC, [test_results_score_type_code] ASC, [replicate] ASC);
