CREATE TABLE [accession_inv_attach] (
    ...
    CONSTRAINT [fk_aiat_c] FOREIGN KEY ([attach_cooperator_id]) REFERENCES [cooperator] ([cooperator_id]),
    CONSTRAINT [fk_aiat_created] FOREIGN KEY ([created_by]) REFERENCES [cooperator] ([cooperator_id]),
    CONSTRAINT [fk_aiat_iid] FOREIGN KEY ([inventory_id]) REFERENCES [inventory] ([inventory_id]),
    CONSTRAINT [fk_aiat_modified] FOREIGN KEY ([modified_by]) REFERENCES [cooperator] ([cooperator_id]),
    CONSTRAINT [fk_aiat_owned] FOREIGN KEY ([owned_by]) REFERENCES [cooperator] ([cooperator_id])
);


GO
CREATE NONCLUSTERED INDEX [ndx_fk_aiat_c]
    ON [accession_inv_attach]([attach_cooperator_id] ASC);


GO
CREATE NONCLUSTERED INDEX [ndx_fk_aiat_created]
    ON [accession_inv_attach]([created_by] ASC);


GO
CREATE NONCLUSTERED INDEX [ndx_fk_aiat_iid]
    ON [accession_inv_attach]([inventory_id] ASC);


GO
CREATE NONCLUSTERED INDEX [ndx_fk_aiat_modified]
    ON [accession_inv_attach]([modified_by] ASC);


GO
CREATE NONCLUSTERED INDEX [ndx_fk_aiat_owned]
    ON [accession_inv_attach]([owned_by] ASC);


GO
CREATE UNIQUE NONCLUSTERED INDEX [ndx_uniq_aiat]
    ON [accession_inv_attach]([inventory_id] ASC, [virtual_path] ASC);


GO
GRANT SELECT
    ON OBJECT::[accession_inv_attach] TO [gg_search]
    AS [dbo];
