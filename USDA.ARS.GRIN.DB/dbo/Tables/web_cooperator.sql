CREATE TABLE [dbo].[web_cooperator] (
    ...
    CONSTRAINT [fk_wc_created] FOREIGN KEY ([created_by]) REFERENCES [dbo].[web_user] ([web_user_id]),
    CONSTRAINT [fk_wc_g] FOREIGN KEY ([geography_id]) REFERENCES [dbo].[geography] ([geography_id]),
    CONSTRAINT [fk_wc_modified] FOREIGN KEY ([modified_by]) REFERENCES [dbo].[web_user] ([web_user_id]),
    CONSTRAINT [fk_wc_owned] FOREIGN KEY ([owned_by]) REFERENCES [dbo].[web_user] ([web_user_id])
);
