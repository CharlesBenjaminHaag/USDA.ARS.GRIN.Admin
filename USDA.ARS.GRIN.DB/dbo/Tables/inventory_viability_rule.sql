CREATE TABLE [dbo].[inventory_viability_rule] (
    ...
    CONSTRAINT [fk_ivr_created] FOREIGN KEY ([created_by]) REFERENCES [dbo].[cooperator] ([cooperator_id]),
    CONSTRAINT [fk_ivr_modified] FOREIGN KEY ([modified_by]) REFERENCES [dbo].[cooperator] ([cooperator_id]),
    CONSTRAINT [fk_ivr_owned] FOREIGN KEY ([owned_by]) REFERENCES [dbo].[cooperator] ([cooperator_id])
);


GO
CREATE NONCLUSTERED INDEX [ndx_fk_ivr_created]
    ON [dbo].[inventory_viability_rule]([created_by] ASC);


GO
CREATE NONCLUSTERED INDEX [ndx_fk_ivr_modified]
    ON [dbo].[inventory_viability_rule]([modified_by] ASC);


GO
CREATE NONCLUSTERED INDEX [ndx_fk_ivr_owned]
    ON [dbo].[inventory_viability_rule]([owned_by] ASC);


GO
CREATE UNIQUE NONCLUSTERED INDEX [ndx_uniq_ivr]
    ON [dbo].[inventory_viability_rule]([name] ASC);
