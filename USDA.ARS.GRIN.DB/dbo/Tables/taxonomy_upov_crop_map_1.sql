CREATE TABLE [taxonomy_upov_crop_map] (
    ...
    CONSTRAINT [FK_taxonomy_upov_crop_map_taxonomy_ref_upov_crop] FOREIGN KEY ([taxonomy_upov_crop_id]) REFERENCES [taxonomy_ref_upov_crop] ([taxonomy_ref_upov_crop_id]),
    CONSTRAINT [FK_taxonomy_upov_crop_map_taxonomy_species] FOREIGN KEY ([taxonomy_species_id]) REFERENCES [taxonomy_species] ([taxonomy_species_id])
);
