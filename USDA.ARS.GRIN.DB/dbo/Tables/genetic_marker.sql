CREATE TABLE [dbo].[genetic_marker] (
    ...
    CONSTRAINT [fk_gm_cr] FOREIGN KEY ([crop_id]) REFERENCES [dbo].[crop] ([crop_id]),
    CONSTRAINT [fk_gm_created] FOREIGN KEY ([created_by]) REFERENCES [dbo].[cooperator] ([cooperator_id]),
    CONSTRAINT [fk_gm_modified] FOREIGN KEY ([modified_by]) REFERENCES [dbo].[cooperator] ([cooperator_id]),
    CONSTRAINT [fk_gm_owned] FOREIGN KEY ([owned_by]) REFERENCES [dbo].[cooperator] ([cooperator_id])
);


GO
CREATE NONCLUSTERED INDEX [ndx_fk_gm_cr]
    ON [dbo].[genetic_marker]([crop_id] ASC);


GO
CREATE NONCLUSTERED INDEX [ndx_fk_gm_created]
    ON [dbo].[genetic_marker]([created_by] ASC);


GO
CREATE NONCLUSTERED INDEX [ndx_fk_gm_modified]
    ON [dbo].[genetic_marker]([modified_by] ASC);


GO
CREATE NONCLUSTERED INDEX [ndx_fk_gm_owned]
    ON [dbo].[genetic_marker]([owned_by] ASC);


GO
CREATE UNIQUE NONCLUSTERED INDEX [ndx_uniq_gm_crop]
    ON [dbo].[genetic_marker]([crop_id] ASC, [name] ASC);
