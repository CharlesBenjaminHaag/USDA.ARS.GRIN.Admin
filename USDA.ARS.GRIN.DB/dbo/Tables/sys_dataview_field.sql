CREATE TABLE [dbo].[sys_dataview_field] (
    ...
    CONSTRAINT [fk_srf_created] FOREIGN KEY ([created_by]) REFERENCES [dbo].[cooperator] ([cooperator_id]),
    CONSTRAINT [fk_srf_modified] FOREIGN KEY ([modified_by]) REFERENCES [dbo].[cooperator] ([cooperator_id]),
    CONSTRAINT [fk_srf_owned] FOREIGN KEY ([owned_by]) REFERENCES [dbo].[cooperator] ([cooperator_id]),
    CONSTRAINT [fk_srf_sr] FOREIGN KEY ([sys_dataview_id]) REFERENCES [dbo].[sys_dataview] ([sys_dataview_id]),
    CONSTRAINT [fk_srf_stf] FOREIGN KEY ([sys_table_field_id]) REFERENCES [dbo].[sys_table_field] ([sys_table_field_id])
);


GO
CREATE NONCLUSTERED INDEX [ndx_fk_srf_created]
    ON [dbo].[sys_dataview_field]([created_by] ASC);


GO
CREATE NONCLUSTERED INDEX [ndx_fk_srf_modified]
    ON [dbo].[sys_dataview_field]([modified_by] ASC);


GO
CREATE NONCLUSTERED INDEX [ndx_fk_srf_owned]
    ON [dbo].[sys_dataview_field]([owned_by] ASC);


GO
CREATE NONCLUSTERED INDEX [ndx_fk_srf_sr]
    ON [dbo].[sys_dataview_field]([sys_dataview_id] ASC);


GO
CREATE NONCLUSTERED INDEX [ndx_fk_srf_stf]
    ON [dbo].[sys_dataview_field]([sys_table_field_id] ASC);


GO
CREATE UNIQUE NONCLUSTERED INDEX [ndx_uniq_sdf]
    ON [dbo].[sys_dataview_field]([sys_dataview_id] ASC, [field_name] ASC);
