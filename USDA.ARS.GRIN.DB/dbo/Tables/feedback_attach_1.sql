CREATE TABLE [feedback_attach] (
    ...
    CONSTRAINT [fk_fa_f] FOREIGN KEY ([feedback_id]) REFERENCES [feedback] ([feedback_id])
);


GO
GRANT DELETE
    ON OBJECT::[feedback_attach] TO [gg_user]
    AS [dbo];
...
GO
GRANT SELECT
    ON OBJECT::[feedback_attach] TO [gg_search]
    AS [dbo];
