CREATE TABLE [inventory] (
    ...
    CONSTRAINT [fk_i_a] FOREIGN KEY ([accession_id]) REFERENCES [accession] ([accession_id]),
    CONSTRAINT [fk_i_backup_i] FOREIGN KEY ([backup_inventory_id]) REFERENCES [inventory] ([inventory_id]),
    CONSTRAINT [fk_i_created] FOREIGN KEY ([created_by]) REFERENCES [cooperator] ([cooperator_id]),
    CONSTRAINT [fk_i_im] FOREIGN KEY ([inventory_maint_policy_id]) REFERENCES [inventory_maint_policy] ([inventory_maint_policy_id]),
    CONSTRAINT [fk_i_m1] FOREIGN KEY ([preservation_method_id]) REFERENCES [method] ([method_id]),
    CONSTRAINT [fk_i_m2] FOREIGN KEY ([regeneration_method_id]) REFERENCES [method] ([method_id]),
    CONSTRAINT [fk_i_modified] FOREIGN KEY ([modified_by]) REFERENCES [cooperator] ([cooperator_id]),
    CONSTRAINT [fk_i_owned] FOREIGN KEY ([owned_by]) REFERENCES [cooperator] ([cooperator_id]),
    CONSTRAINT [fk_i_parent_i] FOREIGN KEY ([parent_inventory_id]) REFERENCES [inventory] ([inventory_id])
);


GO
CREATE NONCLUSTERED INDEX [ndx_fk_i_a]
    ON [inventory]([accession_id] ASC);


GO
CREATE NONCLUSTERED INDEX [ndx_fk_i_backup_i]
    ON [inventory]([backup_inventory_id] ASC);


GO
CREATE NONCLUSTERED INDEX [ndx_fk_i_created]
    ON [inventory]([created_by] ASC);


GO
CREATE NONCLUSTERED INDEX [ndx_fk_i_im]
    ON [inventory]([inventory_maint_policy_id] ASC);


GO
CREATE NONCLUSTERED INDEX [ndx_fk_i_m1]
    ON [inventory]([preservation_method_id] ASC);


GO
CREATE NONCLUSTERED INDEX [ndx_fk_i_m2]
    ON [inventory]([regeneration_method_id] ASC);


GO
CREATE NONCLUSTERED INDEX [ndx_fk_i_modified]
    ON [inventory]([modified_by] ASC);


GO
CREATE NONCLUSTERED INDEX [ndx_fk_i_owned]
    ON [inventory]([owned_by] ASC);


GO
CREATE NONCLUSTERED INDEX [ndx_fk_i_parent_i]
    ON [inventory]([parent_inventory_id] ASC);


GO
CREATE NONCLUSTERED INDEX [ndx_inv_number]
    ON [inventory]([inventory_number_part2] ASC);


GO
CREATE NONCLUSTERED INDEX [ndx_inv_part3]
    ON [inventory]([inventory_number_part3] ASC);


GO
CREATE NONCLUSTERED INDEX [ndx_inv_prefix]
    ON [inventory]([inventory_number_part1] ASC);


GO
CREATE UNIQUE NONCLUSTERED INDEX [ndx_uniq_inv]
    ON [inventory]([inventory_number_part1] ASC, [inventory_number_part2] ASC, [inventory_number_part3] ASC, [form_type_code] ASC);


GO
CREATE STATISTICS [_dta_stat_1957582012_29_1]
    ON [inventory]([accession_id], [inventory_id]);


GO
GRANT DELETE
    ON OBJECT::[inventory] TO [gg_user]
    AS [dbo];
...
GO
GRANT SELECT
    ON OBJECT::[inventory] TO [gg_search]
    AS [dbo];
