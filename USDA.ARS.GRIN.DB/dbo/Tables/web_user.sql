CREATE TABLE [dbo].[web_user] (
    ...
    CONSTRAINT [fk_wu_sl] FOREIGN KEY ([sys_lang_id]) REFERENCES [dbo].[sys_lang] ([sys_lang_id]),
    CONSTRAINT [fk_wu_wc] FOREIGN KEY ([web_cooperator_id]) REFERENCES [dbo].[web_cooperator] ([web_cooperator_id])
);


GO
CREATE UNIQUE NONCLUSTERED INDEX [ndx_uniq_wu]
    ON [dbo].[web_user]([user_name] ASC);
