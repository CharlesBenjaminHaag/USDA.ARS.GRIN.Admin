CREATE TABLE [inventory_maint_policy] (
    ...
    CONSTRAINT [fk_im_co] FOREIGN KEY ([curator_cooperator_id]) REFERENCES [cooperator] ([cooperator_id]),
    CONSTRAINT [fk_im_created] FOREIGN KEY ([created_by]) REFERENCES [cooperator] ([cooperator_id]),
    CONSTRAINT [fk_im_modified] FOREIGN KEY ([modified_by]) REFERENCES [cooperator] ([cooperator_id]),
    CONSTRAINT [fk_im_owned] FOREIGN KEY ([owned_by]) REFERENCES [cooperator] ([cooperator_id])
);


GO
CREATE NONCLUSTERED INDEX [ndx_fk_im_co]
    ON [inventory_maint_policy]([curator_cooperator_id] ASC);


GO
CREATE NONCLUSTERED INDEX [ndx_fk_im_created]
    ON [inventory_maint_policy]([created_by] ASC);


GO
CREATE NONCLUSTERED INDEX [ndx_fk_im_modified]
    ON [inventory_maint_policy]([modified_by] ASC);


GO
CREATE NONCLUSTERED INDEX [ndx_fk_im_owned]
    ON [inventory_maint_policy]([owned_by] ASC);


GO
CREATE UNIQUE NONCLUSTERED INDEX [ndx_uniq_im]
    ON [inventory_maint_policy]([maintenance_name] ASC);


GO
GRANT DELETE
    ON OBJECT::[inventory_maint_policy] TO [gg_user]
    AS [dbo];
...
GO
GRANT SELECT
    ON OBJECT::[inventory_maint_policy] TO [gg_search]
    AS [dbo];
