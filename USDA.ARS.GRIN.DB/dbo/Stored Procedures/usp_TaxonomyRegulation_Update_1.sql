...
BEGIN
BEGIN TRY
	UPDATE taxonomy_regulation SET geography_id=@geography_id,regulation_type_code=@regulation_type_code,regulation_level_code=@regulation_level_code,description=@description,url_1=@url_1,url_2=@url_2,note=@note,created_date=@created_date,created_by=@created_by,modified_date=@modified_date,modified_by=@modified_by,owned_date=@owned_date,owned_by=@owned_by 
