...
CREATE FUNCTION [get_obs_by_acid2](@acid int, @crop nvarchar(30), @trait nvarchar(40)) RETURNS nvarchar(4000)
...
GO
GRANT EXECUTE
    ON OBJECT::[get_obs_by_acid2] TO [gg_user]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[get_obs_by_acid2] TO [gg_search]
    AS [dbo];
